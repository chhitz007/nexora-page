...
export default function VisionMissionSection({ openVMModal }: VisionMissionSectionProps) {
    return (
      ...
      `}</style>
            ...
            <section className="py-8 md:py-8 bg-gray-100">
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        {/* FIXED: Changed text-gray-600 to text-gray-700 for better contrast on bg-gray-100 */}
                    ...
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                        {/* Vision Card */}
                        <div
                            className={`p-8 rounded-xl relative overflow-hidden group cursor-pointer transition-all duration-500 ease-out bg-white border border-gray-100 hover:shadow-xl hover:border-teal-400 hover:-translate-y-1`}
                            onClick={() => openVMModal(visionContent)}
                        >
                            {/* Effects (Unchanged) */}
                            <div className="absolute inset-0 bg-gradient-to-br from-teal-500/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                            ...
                            <div className="absolute top-0 left-0 w-full h-1 bg-gray-200">
                                <div className="h-full bg-teal-500 w-0 group-hover:w-full transition-all duration-500 ease-out"></div>
                            </div>

                            {/* Vision Card Content */}
                            <h3 className="text-3xl font-extrabold font-serif mb-3 relative z-10 text-teal-600 group-hover:text-teal-700 transition-colors duration-300">
                                Our Vision
                            </h3>
                            ...
                            <div className="mt-6 relative z-10 flex items-center text-base font-bold text-teal-600 group-hover:text-teal-700 transition-colors duration-200">
